...
class ConnectButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          launchUrl(Uri.parse("https://wa.me/917017908507?text=Hi, Sagar Mittal, I've gone through your portfolio, and I want to connect with you for career opportunities."));
        },
